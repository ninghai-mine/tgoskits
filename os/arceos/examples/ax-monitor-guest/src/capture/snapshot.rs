...
const KALLSYMS_ADDRS: Option<KallsymsAddrs> = Some(KallsymsAddrs {
    num_syms_gpa:         0x2241605d8,
    relative_base_gpa:    0x2242cdf28,
    offsets_gpa:          0x22427aa50,
    names_gpa:            0x2241605e0,
    token_table_gpa:      0x22427a4c0,
    token_index_gpa:      0x22427a850,
    markers_gpa:          0x224279f88,
});
